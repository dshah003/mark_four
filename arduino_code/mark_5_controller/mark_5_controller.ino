/*
   ...
   It subscribes to ROS nodes as required and performs accordingly.
   Features:
   - Controls 2 DC motors
   - reads 2 Rotary Encoders and publishes info to ROS serial.
   - Reads info from ROS_serial and controls DC motors.
*/
